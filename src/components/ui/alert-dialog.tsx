  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-surface border border-border/50 rounded-2xl shadow-2xl shadow-black/40",
...
const AlertDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:gap-3 mt-6 pt-4 border-t border-border/50", className)}
    {...props}
  />
);
...
const AlertDialogAction = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action> & { variant?: Parameters<typeof buttonVariants>[0]["variant"] }
