...
export const handlers = [
  http.get(`${SUPABASE_URL}/rest/v1/clientes`, () => {
    return HttpResponse.json([
      { id: '1', nome_doutor: 'Dr. Teste', email: 'dr@teste.com', created_at: '2024-01-01T00:00:00Z' },
      { id: '2', nome_doutor: 'Dra. Exemplo', email: 'dra@exemplo.com', created_at: '2024-01-02T00:00:00Z' },
    ]);
  }),
  ...
  http.patch(`${SUPABASE_URL}/rest/v1/clientes`, async ({ request }) => {
    const body = await request.json();
    return HttpResponse.json({ id: '1', ...body as object, updated_at: '2024-06-30T00:00:00Z' });
  }),
