...
const TUTORIAIS: Tutorial[] = [
  { id: "gerar-link", title: "Como gerar um link de cadastro", desc: "Aprenda a criar e compartilhar links de pré-cadastro com seus clientes.", url: "#" },
  { id: "analisar-cadastro", title: "Como analisar um cadastro", desc: "Veja como revisar documentos e aprovar ou solicitar correções.", url: "#" },
  { id: "credenciais", title: "Gerenciar credenciais da equipe", desc: "Saiba como adicionar e gerenciar usuários do sistema.", url: "#" },
  { id: "relatorios", title: "Exportar relatórios", desc: "Aprenda a gerar relatórios em PDF do sistema.", url: "#" },
  { id: "pre-cadastro", title: "Fluxo de pré-cadastro", desc: "Entenda o passo a passo que o cliente percorre no pré-cadastro.", url: "#" },
];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-6">
      <div className="w-full max-w-md rounded-2xl bg-card p-6 shadow-xl max-h-[85vh] overflow-y-auto">
        ...
        {selected ? (
          <div>
            <button onClick={() => setSelected(null)} className="mb-3 text-xs text-accent hover:underline">&larr; Voltar</button>
            <h3 className="mb-2 text-sm font-bold text-text-main">{selected.title}</h3>
