        ...
        {empresas.map((emp) => (
          <div key={emp.id} className="flex items-center justify-between p-3 rounded-lg bg-card border border-border-subtle">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/admin/super/empresas/$id" params={{ id: emp.id }} className="p-1.5 rounded-lg text-text-muted hover:text-accent hover:bg-surface-hover transition-colors" title="Editar">
                <Pencil size={14} />
              </Link>
