...
function CadastroFormDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#0f172a] border-[var(--color-border-subtle)] text-white overflow-hidden max-w-lg">
        <DialogHeader>
        ...
        <DialogFooter className="p-6 border-t border-[var(--color-border-subtle)]">
          <button
