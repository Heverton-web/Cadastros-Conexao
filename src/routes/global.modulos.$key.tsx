...
function AdminSuperModuloDetail() {
  ...
  if (!mod) {
    return (
      <div className="p-4 max-w-4xl mx-auto">
        <button onClick={() => navigate({ to: "/global/modulos" })} className="flex items-center gap-1 text-sm text-accent mb-4">
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <button onClick={() => navigate({ to: "/global/modulos" })} className="flex items-center gap-1 text-sm text-accent mb-4 hover:underline">
