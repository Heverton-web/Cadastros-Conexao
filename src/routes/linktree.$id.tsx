...
import { LinkTreeCard } from "~/features/linktree/components/LinkTreeCard";

export const Route = createFileRoute("/linktree/$id")({
  ssr: false,
  component: PublicLinkTreePage,
  notFoundComponent: () => (
    <Centered title="Cartao nao encontrado" message="Verifique o link com quem o compartilhou." />
  ),
  errorComponent: () => (
    <Centered title="Nao foi possivel abrir o cartao" message="Tente novamente em instantes." />
  ),
});
