      ...
      >
        ...
        {isLast ? (
          <div className="text-center animate-in zoom-in-95 duration-700 py-6">
            ...
            <h1 className="text-2xl font-semibold mb-3 tracking-tight" style={{ color: "var(--nps-complete-title)" }}>Obrigado!</h1>
            <p className="text-sm md:text-base leading-relaxed" style={{ color: "var(--nps-complete-subtitle)" }}>Seu feedback é muito importante para nós.</p>
          </div>
        ) : (
                ...
                {(currentQ.options || []).map((opt, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isSelected && <div className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: "var(--nps-radio-selected)" }} />}
                      </div>
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              >
                <svg className="w-6 h-6" style={{ color: "var(--nps-modal-icon-color)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" /></svg>
              </div>
