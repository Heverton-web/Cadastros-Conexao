...
function CatalogoStoreContent({ empresaId }: { empresaId: string }) {
  ...
  return (
    <StoreLayout empresaId={empresaId} fullHeight>
      <div className="flex flex-col overflow-hidden flex-1">
        ...
        {visibility.showCategoryCards && (
          <div className="flex-1 px-4 sm:px-6 lg:px-16 pt-2 pb-4 max-w-7xl mx-auto w-full flex flex-col justify-center">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 auto-rows-fr relative z-20 w-full">
              {cardKeys.map((key) => {
        ...
        {visibility.showFooter && footer && (
          <div className="shrink-0 px-4 sm:px-6 lg:px-16 py-2.5 flex items-center justify-between">
            <p className="text-[10px] sm:text-xs text-[var(--color-text-muted)]">
              {footer.text} &copy; {new Date().getFullYear()}
            </p>
            <div className="flex items-center gap-2.5">
              {footer.socialLinks.instagram && (
                <a href={footer.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
              ...
              {footer.socialLinks.facebook && (
                <a href={footer.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
              ...
              {footer.socialLinks.linkedin && (
                <a href={footer.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
              ...
              {footer.socialLinks.whatsapp && (
                <a href={`https://wa.me/${footer.socialLinks.whatsapp}`} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
              ...
              {footer.socialLinks.youtube && (
                <a href={footer.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
              ...
              {footer.socialLinks.tiktok && (
                <a href={footer.socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-80 text-[var(--color-text-muted)]">
