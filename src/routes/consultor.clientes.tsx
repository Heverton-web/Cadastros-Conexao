  ...
  return (
    <div className="flex flex-col gap-6 p-4 pb-24">
      ...
      <div className="relative">
        ...
        <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar clientes..." className="w-full rounded-xl border border-input-border bg-input-bg py-4 pl-12 pr-4 text-base text-text-main outline-none focus:border-accent focus:ring-4 focus:ring-accent/10 min-h-[56px] transition-all shadow-sm" />
      </div>
      ...
      : <div className="flex flex-col gap-4">{filtered.map((c) => (
