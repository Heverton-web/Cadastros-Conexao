...
import { LinktreeThemeEditor } from "~/features/linktree/components/LinktreeThemeEditor";
import { normalizeLinktreeTheme, type LinktreeThemeConfig } from "~/features/linktree/types";

export const Route = createFileRoute("/linktree/tema")({
  component: LinktreeTemaPage,
});

function LinktreeTemaPage() {
