...
export const LINKTREE_PERMISSIONS: { key: keyof Permissoes; label: string; description: string; group: string }[] = [
  ...
  { key: "lt_empresa_ver", label: "Ver linktree da empresa", description: "Visualizar painel do linktree da empresa", group: "LinkTree Empresa" },
  { key: "lt_empresa_editar", label: "Editar linktree da empresa", description: "Editar links, secoes e configuracoes do linktree", group: "LinkTree Empresa" },
  { key: "lt_empresa_ver_analytics", label: "Ver analytics do linktree", description: "Visualizar relatorio de cliques do linktree", group: "LinkTree Empresa" },
  { key: "lt_empresa_gerar_qr", label: "Gerar QR Code do linktree", description: "Gerar e baixar QR Code do linktree da empresa", group: "LinkTree Empresa" },
];
