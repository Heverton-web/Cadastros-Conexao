      ...
      <Dialog open={novaCampanhaOpen} onOpenChange={setNovaCampanhaOpen}>
        <DialogContent className="max-w-md bg-card border-border">
          <DialogHeader>
            ...
            <DialogDescription>Crie um rascunho de campanha de e-mail marketing.</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleCriarCampanha} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="ghost" onClick={() => setNovaCampanhaOpen(false)}>
                Cancelar
              </Button>
      ...
      <AlertDialog open={!!paraExcluir} onOpenChange={(o) => !o && setParaExcluir(null)}>
        <AlertDialogContent className="bg-card border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              A campanha "{paraExcluir?.nome}" será removida permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
