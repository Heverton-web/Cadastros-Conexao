    ...
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight text-white tracking-tighter">{title}</h1>
          <p className="text-lg mt-2 text-[var(--color-text-muted)]">{subtitle}</p>
        </div>
      </div>
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group relative text-left rounded-2xl border-solid p-5 transition-all duration-300 overflow-hidden",
                opt.disabled
