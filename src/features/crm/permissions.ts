export const CRM_PERMISSIONS = [
  ...
  { key: "crm_pipeline" as const, label: "Acessar pipeline", description: "Visualizar pipeline de vendas", group: "CRM" },
  { key: "crm_tarefas" as const, label: "Gerenciar tarefas", description: "Criar e gerenciar tarefas", group: "CRM" },
  ...
  { key: "crm_metricas" as const, label: "Acessar métricas", description: "Visualizar métricas avançadas", group: "CRM" },
