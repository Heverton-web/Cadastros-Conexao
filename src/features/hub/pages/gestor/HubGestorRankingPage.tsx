...
export function HubGestorRankingPage() {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="relative rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden">
        ...
        <div className="relative z-10 p-5 sm:p-8 md:p-10">
          ...
          <p className="text-sm sm:text-base max-w-lg font-medium" style={{ color: "var(--color-text-muted)" }}>Gestores, Consultores e Distribuidores com mais XP.</p>
        </div>
      </div>
