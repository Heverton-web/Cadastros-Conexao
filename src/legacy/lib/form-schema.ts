...
/**
 * Carrega os campos visíveis de uma etapa para um tipo de pessoa.
 * Usado pelo formulário do lead (filtra visivel=true).
 */
...
/**
 * Lista todos os campos (admin — sem filtro de visibilidade).
 * Pode filtrar por etapa e/ou tipo_pessoa.
 */
...
/**
 * Salva (cria ou atualiza) um campo.
 */
...
/**
 * Exclui um campo (apenas is_custom = true).
 */
...
/**
 * Atualiza a ordem de múltiplos campos de uma vez.
 */
...
/**
 * Toggle rápido de visibilidade ou obrigatoriedade.
 */
...
/**
 * Edita apenas o label de um campo.
 */
