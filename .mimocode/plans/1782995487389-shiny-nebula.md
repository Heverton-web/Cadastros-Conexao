...
Remodelação completa do schema do banco de dados para arquitetura multi-empresa com 4 tabelas core (USUARIOS, EMPRESAS, COLABORADORES, CLIENTES) e módulos auto-contidos que compartilham esses dados centrais.
