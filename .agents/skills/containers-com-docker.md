---
name: epub-containers-com-docker
description: >-
  Passos operacionais extraidos do livro 'EPUB_Containers_com_Docker' (PT) — praticas e procedimentos para DevOps, infraestrutura e containers.
---

# Containers Com Docker — Passos Operacionais

Conteudo extraido do livro 'Containers Com Docker'. Contem passos, tecnicas e principios baseados na obra original.
