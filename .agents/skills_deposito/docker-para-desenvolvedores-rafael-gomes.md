---
name: docker-para-desenvolvedores-rafael-gomes
description: >-
  Passos operacionais extraidos do livro 'Docker para Desenvolvedores - Rafael Gomes' (PT) — praticas e procedimentos para DevOps, infraestrutura e containers.
---

# Docker Para Desenvolvedores Rafael Gomes — Passos Operacionais

Conteudo extraido do livro 'Docker Para Desenvolvedores Rafael Gomes'. Contem passos, tecnicas e principios baseados na obra original.
...
- Neste livro, adotamos as práticas do 12factor¹.
...
- A ideia é que você possa exercitar com um   código de verdade e, assim, assimilar o conteúdo de forma  ¹https://12factor.net/pt_br/   Como ler esse livro   4  prática.
...
- Aproveito para agradecer a pessoa que me apresentou o   Docker, Robinho², também conhecido como Robson Peixoto.
...
- Se não   fosse ele, o livro não teria saído tão rápido.  ²https://twitter.com/robinhopeixoto   Agradecimentos   6  Obrigada a fantástica Emma Pinheiro³, pela belíssima capa.
