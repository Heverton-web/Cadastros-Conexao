# bubble_reverse_engineering — AGENTS.md

**Language:** Brazilian Portuguese (pt-BR)

## Pipeline Principal

`/bubble-tech-lead [@caminho/json]` — pipeline autônomo completo.

## Modo Eco (Economia Tokens)

Skills comprimidas em caveman `full`. Originais em `SKILL.original.md`.
...
## Domínios esperados no JSON

`pages`, `data_types`/`user_types`, `option_sets`, `backend_workflows`, `api_connectors`, `reusable_elements`
