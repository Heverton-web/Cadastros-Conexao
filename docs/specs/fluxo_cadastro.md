...
*   **Funcionamento**:
    1. O administrador clica em **Nova** e preenche: *Nome Completo, E-mail Corporativo, WhatsApp Corporativo e Departamento*.
...
*   **Funcionamento**:
    ...
    2. **O Formulário de 5 Etapas com Timer**:
        ...
        *   *Webhooks*: Dispara o webhook `dados_enviados` e o webhook `em_analise` ao finalizar e enviar todo o conjunto de dados.
...
*   **Funcionamento**:
    1. O analista de cadastro visualiza os dados divididos em três colunas organizadas: *Dados do Cliente*, *Endereço* e *Documentos*.
